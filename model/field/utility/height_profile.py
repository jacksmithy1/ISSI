...
def f(z: np.float64, z0: np.float64, deltaz: np.float64, a: np.float64, b: np.float64):
    return a * (1.0 - b * np.tanh((z - z0) / deltaz))


def f_low(z: np.float64, a: np.float64, kappa: np.float64):
...
def dfdz_low(z: np.float64, a: np.float64, kappa: np.float64):
