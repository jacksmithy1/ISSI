...
from issi.plot_magnetogram import plot_magnetogram_boundary, plot_fieldlines_grid
from issi.get_data import get_magnetogram_SOAR
...
def main():
    ...
    plot_magnetogram_boundary(photo_data, 800, 500)

    data = get_magnetogram_SOAR(photo_data)
